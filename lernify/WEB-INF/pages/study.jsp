    ...
    <%@ page import="models.User" %>
        <% User user=(User)session.getAttribute("user"); %>
            ...
            <body class="overflow-hidden">
                        ...
                        <div class="col-lg-9 p-4 vh-100 overflow-auto mt-5 mb-2 z-2">
                            ...
                            <div class="mt-2">
                                <nav aria-label="breadcrumb">
                                    <ol
                                        class="breadcrumb bg-light p-3 rounded shadow-sm d-flex justify-content-between align-items-center">
                            ...
                            <div class="row mt-2">
                                <div class="col d-flex justify-content-between align-items-center p-2 mx-4">
                                    <a href="${prev}"
                                        class="btn btn-info fs-6 text-black fw-bold d-flex justify-content-center align-items-center ${isprev ? '' : 'disabled'}">
                                        <i class="fa-solid fa-caret-left me-1"></i> Prev
                                    </a>

                                    <!-- Lecture Title in Center -->
                                    <h2 class="fw-bold text-dark rounded border bg-white shadow-sm p-2 mx-4 fs-2 text-center px-5"
                                        style="margin: auto;">
                                        <span class="text-secondary">${loc}</span> ${playCurrent.title}
                                    </h2>

                                    <a href="${next}" id="next-lec"
                                        class="btn btn-info fs-6 text-black fw-bold d-flex justify-content-center align-items-center ${isnext ? '' : 'disabled'}">
                ...
                <div class="modal fade" id="addNotesModal" tabindex="-1" aria-labelledby="addNotesLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control border-1 shadow-sm" id="noteTitle" placeholder="Enter note title"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control border-1 shadow-sm" id="noteContent" rows="5"
                                        placeholder="Write your notes here..." style="background-color: #fdfdfd; border-color: #ddd;"></textarea>
                                </div>
                            </div>
